...
with col_right:
    ...
    with kpi_col2:
        ...
        <div style="background-color: white; padding: 20px; border-radius: 12px; border: 1px solid #e2e8f0; border-top: 4px solid #1e293b; box-shadow: 0 1px 3px 0 rgba(0,0,0,0.05); position: relative; overflow: hidden;">
            <span class="metric-label-black" style="display: block; text-transform: uppercase; font-size: 81px; font-weight: 700; color: #000000 !important; tracking-wider">Predicted Churn Risk</span>
    ...
    <div style="background-color: white; padding: 20px; border-radius: 12px; border: 1px solid #e2e8f0; margin-bottom: 24px; box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05);">
        <span style="font-size: 15px; font-weight: bold; background-color: #f5f3ff; color: #4f46e5; padding: 4px 12px; border-radius: 6px; text-transform: uppercase; border: 1px solid #ddd6fe;">
